...
export class UsersService {
    ...
    public async toggleIsDeletedUser(
    ...
    public async changeUserRole(userId: number) {
        const user = await this.getUserById(userId);
        const newUserRole: UserRole = user.role === UserRole.Admin ? UserRole.Basic : UserRole.Admin;
