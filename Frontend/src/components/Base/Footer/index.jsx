  ...
  return (
    ...
    <MDBFooter color="unique-color-dark" className="page-footer font-small pt-0">
      ...
      <MDBContainer className="mt-5 mb-4 text-center text-md-left">
        <MDBRow className="mt-3">
          ...
          <MDBCol md="4" lg="3" xl="3" className="mb-4">
            ...
            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
            <p>
              <i className="fa fa-home mr-3" /> NBU Sofia, Bulgaria
            </p>
            <p>
              <i className="fa fa-envelope mr-3" /> bm_library@gmail.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> + 02 123 456 789
            </p>
            <p>
              <i className="fa fa-print mr-3" /> + 02 582 555 693
            </p>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
      ...
      <div className="footer-copyright text-center py-3">
        <MDBContainer fluid>
          &copy; {new Date().getFullYear()} Copyright: <a href="some_gitlab_repo"> Bogomila & Mariela </a>
        </MDBContainer>
      </div>
    </MDBFooter>
  );
